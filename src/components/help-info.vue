<template>
  <view class="help-info">
    ...
    <view class="item" v-show="currentTab === 0">
      <span>
        通过虚拟手柄<img src="http://81.68.189.158:87/project/sokoban-static//img/help-info/handle.png" alt="" /> 控制人物移动，将所有箱子
      ...
      <span
        ...
        它们将夺走您的生命<img src="http://81.68.189.158:87/project/sokoban-static//img/help-info/heart.png" alt=""
      /></span>
      <span>
        ● 如果您想了解更多地图元素
        <div class="img-box fire"></div>
        的作用，请点击上方
        <span style="font-weight: bold; display: inline"><img src="http://81.68.189.158:87/project/sokoban-static//img/help-info/map-manual.png" alt="" />地图手册</span>
      </span>
    </view>
