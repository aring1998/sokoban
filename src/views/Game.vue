  ...
  methods: {
    ...
    move(direction, step) {
      ...
      if (fromPlace == 5 || fromPlace == 6) 
        Vue.set(this.gameMap[this.playerY], this.playerX, 4)
      else
        Vue.set(this.gameMap[this.playerY], this.playerX, 1)
      ...
      switch(toPlace) {
        ...
        case 5: {  // 碰箱子
          if (direction == 'x')
            boxPlace = this.gameMap[this.playerY][+this.playerX + step * 2]
          else
            boxPlace = this.gameMap[+this.playerY + step * 2][this.playerX]
          ...
          if (boxPlace == 4) { // 如果箱子抵达终点
            ...
            Vue.set(this.gameMap[setBoxY], setBoxX, 3)
          // 如果目标点是箱子抵达终点或人物在终点上
      ...
      // 设定移动后的玩家位置
      if (direction == 'x')
        this.playerX = +this.playerX + step
      else
        this.playerY = +this.playerY + step
